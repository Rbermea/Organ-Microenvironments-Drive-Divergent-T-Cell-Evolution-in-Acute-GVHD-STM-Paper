...
```{r}
shared_clonotypes <- readH5AD("/Users/rbermea/Kean Lab Dropbox/Rene Bermea/Final_Repository_Files/annData_objects/clean_hdf5/03_shared_clonotype_object.hdf5")
...
```{r}
plot_cells(cds, label_cell_groups = FALSE, color_cells_by = "pseudotime" , show_trajectory_graph = TRUE, group_label_size = 50, graph_label_size = 3, cell_size = 2, trajectory_graph_segment_size = 5, label_leaves = TRUE, label_roots = TRUE, label_branch_points = TRUE, trajectory_graph_color = "black") # Original Segment Size = 3
```
